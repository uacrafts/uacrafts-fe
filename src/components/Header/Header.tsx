  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.search}>
        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.icon}>
          <path
          ...
          <path d="M18 18.5L14 14.5" stroke="#1A1A1A" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round"/>
        </svg>
        <input id="search" type="text" className={styles.input} placeholder="Я шукаю"/>
